        ...
        try:
            if os.path.exists(FileManager.CONFIG_FILE):
                with open(FileManager.CONFIG_FILE, "r") as file:
                    ...
                    globals()["package_prefix"] = config.get("package_prefix", "com.manh")
                ...
                globals()["package_prefix"] = "com.manh"
                close_and_rejoin_delay = None
                reset_tab_interval = None
                codex_bypass_enabled = False
        except Exception as e:
    ...
    def save_config():
        ...
        try:
            config = {
                ...
                "package_prefix": globals().get("package_prefix", "com.manh"),
...
def main():
    ...
    while True:
        ...
        if setup_type == "1":
            ...
            try:
                current_prefix = globals().get("package_prefix", "com.manh")
